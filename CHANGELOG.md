...
- **Renovate dependency update** ([#56](https://github.com/vig-os/commit-action/pull/56))
  - Update `@typescript-eslint/eslint-plugin` from `^6.13.0` to `^8.0.0`
  - Update `@typescript-eslint/parser` from `^6.13.0` to `^8.0.0`
